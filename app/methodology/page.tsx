...
const GUARANTEES: [string, string][] = [
  [
    ...
    "Панель расчёта и печатный отчёт строятся из одного источника строк, и отдельный тест " +
      ...
      "после того, как расхождение однажды дошло до клиентского отчёта: тот сообщал " +
      "4 425 300 ₽ против 2 267 100 ₽ на экране. Поймали на разборе, до выкатки — и поймали " +
      "не тестом: тест на сквозную сверку был зелёным всё это время, потому что не заходил " +
      "на путь, где ломалось.",
  ],
  [
