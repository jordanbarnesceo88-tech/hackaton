...
describe("computeQuantity", () => {
  ...
  workloadStream: "OPERATION_FLOW", ...base, capacityPerUnit: 50, capacityBasis: "PER_HOUR_FLOW" };
  ...
  it("sizes a PER_DAY_FLOW solution by annualized throughput", () => {
    ...
    const cap: SolutionCapacity = {
  workloadStream: "OPERATION_FLOW", ...base, capacityPerUnit: 400, capacityBasis: "PER_DAY_FLOW" };
  ...
  it("sizes a CONCURRENT_STOCK solution from an explicit peak", () => {
    ...
    const cap: SolutionCapacity = {
  workloadStream: "OPERATION_FLOW", ...base, capacityPerUnit: 12, capacityBasis: "CONCURRENT_STOCK" };
  ...
  it("never returns less than 1", () => {
    const cap: SolutionCapacity = {
  workloadStream: "OPERATION_FLOW", ...base, capacityPerUnit: 999999, capacityBasis: "PER_DAY_FLOW" };
  ...
  it("returns null on non-positive capacity (no divide-by-zero, no throw)", () => {
    const cap: SolutionCapacity = {
  workloadStream: "OPERATION_FLOW", ...base, capacityPerUnit: 0, capacityBasis: "PER_DAY_FLOW" };
