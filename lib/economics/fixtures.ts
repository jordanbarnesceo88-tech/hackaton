...
export function makeCapacity(
  ...
  return {
    ...
    // Контекст задачи. Норматив по умолчанию равен СТАРОМУ глобальному делителю (12 500),
    // чтобы существующие тесты сравнивались с прежними числами всюду, где предел замещения не
    // упирался в штат. Тест, проверяющий новое поведение, передаёт свой.
    categorySlug: "test-task",
    workerOutputPerYear: 12500,
    capacityPerUnit: 400,
