...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // rounded-panel (16px, BCB --r-lg) + a real 1px border (BCB's base panel has no
        // shadow — box-shadow is reserved for surfaces that leave the document flow: modal,
        // toast, dropdown. A real `border` also survives forced-colors mode, where box-shadow
        // rings are stripped.
